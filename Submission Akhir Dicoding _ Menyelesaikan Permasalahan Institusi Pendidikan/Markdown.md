...
**Account Metabase**
   ```
   Email : nurya.fahrurosyidin@gmail.com atau NuryaFR
   Password :  nfr9162tuf12345
   ```
...
### 3. Data Uji Coba (Testing Dataset)
Untuk mempermudah pengujian fitur prediksi massal (batch prediction) pada antarmuka Streamlit, telah disediakan sampel data uji coba berkas **test_data.csv**.
* Lokasi File Lokal: 
    ```
    Dataset/students_performance/test_data.csv
    ```

* Tautan Unduh (GitHub): 

    [Unduh test_data.csv di GitHub](https://github.com/NuryaFahruRosyidin2406/Submission-Akhir-Dicoding-Menyelesaikan-Permasalahan-Institusi-Pendidikan/tree/4ff2b09601aa1a5f4a8a9a2b429b3d220ef65975/Dataset/students_performance) 
## Conclusion
